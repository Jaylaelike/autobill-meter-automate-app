...
class ChiangMaiClient {
  ...
  async loadMonitoredObjects() {
    try {
      if (!this.databaseService || !this.stationRecord) {
        ...
        this.monitoredObjects = [8684, 8685, 8687, 8688, 18069, 18070, 73910, 75426]; // Chiang Mai specific defaults
      ...
      if (monitoredData.count > 0) {
        ...
        this.monitoredObjects = [8684, 8685, 8687, 8688, 18069, 18070, 73910, 75426];
        this.setupObjectLabels();
  ...
  setupObjectLabels(objectMap = null) {
    ...
    const defaultLabels = {
      ...
      18070: "MUX#2 Power Meter",
      73910: "MUX#4 Power Meter",
      75426: "MUX#5 Power Meter",
    };
...
// Main execution
async function main() {
  log("=== Starting Buengkan WebSocket Client ===");
